...
Jest to~model trójwarstwowy, składający się~z~widoku (klient), prezentera (servlety, JSP) i~modelu, czyli logiki i~danych reprezentowanych przez EJB. Projekt nie wymagał użycia bazy danych.
